...
import { Calendar, Users, FileText, MessageSquare, GraduationCap, Clock, MapPin, Download } from "lucide-react"
import { Button } from "@/components/ui/button"

export default function RecruitingPage() {
  const googleFormUrl = "https://docs.google.com/forms/d/e/1FAIpQLSfw9mNxf_smpqGR0AUPbM1cyXcCGexGqimgSyghEmG2R6BaQA/viewform"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-slate-950 dark:via-gray-900 dark:to-slate-950 text-gray-900 dark:text-white transition-colors duration-500">
      ...
      <main className="relative z-10 pt-12 md:pt-20 pb-12 md:pb-32">
        ...
        <section className="py-8 md:py-16 relative">
          <div className="w-full max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12">
            <div className="mb-8 md:mb-16 text-center">
              <h1 className="text-4xl md:text-[52px] lg:text-[64px] font-bold mb-4 md:mb-8 leading-tight">
                ...
                <br />
                <span className="text-gray-900 dark:text-white">리크루팅 안내</span>
              </h1>
            ...
            <div className="bg-white/50 dark:bg-white/5 backdrop-blur-sm border border-gray-200 dark:border-white/10 rounded-2xl p-6 md:p-10 lg:p-12">
              ...
              <div className="pl-0 md:pl-20">
                <p className="text-base md:text-lg text-gray-700 dark:text-white/80 leading-relaxed mb-4">
                  창업에 관심이 있으며, <strong className="text-gray-900 dark:text-white">방학 포함 한 학기 성실하게 활동할 수 있는 인하대학교 학생.</strong>
                </p>
            ...
            <div className="bg-white/50 dark:bg-white/5 backdrop-blur-sm border border-gray-200 dark:border-white/10 rounded-2xl p-6 md:p-10 lg:p-12">
              ...
              <div className="pl-0 md:pl-20 space-y-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-start gap-2">
                  ...
                  <span className="text-base md:text-lg text-[#dc143c] font-semibold">5만원</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="pl-0 md:pl-20 space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-start gap-2">
                  ...
                  <span className="text-base md:text-lg text-gray-700 dark:text-white/80">
                    2026년 2월 2일 월요일 ~ 2월 18일 수요일 <strong className="text-[#dc143c]">23:59까지</strong>
                  </span>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-start gap-2">
                ...
                <div className="mt-6">
                  <Button
                    ...
                    className="bg-gradient-to-r from-black via-[#dc143c] to-[#dc143c] dark:from-black dark:via-[#dc143c] dark:to-[#dc143c] text-white hover:opacity-90 transition-opacity px-6 py-3 text-base md:text-lg"
                  >
                    지원서 작성하기
                  </Button>
                </div>
        ...
        <section className="py-8 md:py-16 relative">
          <div className="w-full max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12">
            <div className="bg-white/50 dark:bg-white/5 backdrop-blur-sm border border-gray-200 dark:border-white/10 rounded-2xl p-6 md:p-10 lg:p-12">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-gradient-to-br from-[#dc143c]/10 to-[#dc143c]/20 dark:from-[#dc143c]/20 dark:to-[#dc143c]/30 flex items-center justify-center border border-gray-200 dark:border-white/10">
                  <GraduationCap className="w-6 h-6 md:w-7 md:h-7 text-[#dc143c]" />
                </div>
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white">
                  오리엔테이션 및 개강총회 <span className="text-base md:text-lg text-[#dc143c]">(필수 참여)</span>
                </h2>
              </div>
              <div className="pl-0 md:pl-20 space-y-4">
          ...
          <div className="w-full max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12">
            <div className="bg-white/50 dark:bg-white/5 backdrop-blur-sm border border-gray-200 dark:border-white/10 rounded-2xl p-6 md:p-10 lg:p-12">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white">
                  팀빌딩 캠프 <span className="text-base md:text-lg text-[#dc143c]">(필수 참여)</span>
                </h2>
              </div>
              <div className="pl-0 md:pl-20 space-y-4">
                <div className="flex items-start gap-3">
        ...
        <section className="py-8 md:py-16 relative">
          <div className="w-full max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12">
            <div className="bg-gradient-to-br from-[#dc143c]/10 via-[#dc143c]/5 to-[#dc143c]/10 dark:from-[#dc143c]/20 dark:via-[#dc143c]/10 dark:to-[#dc143c]/20 backdrop-blur-sm border-2 border-[#dc143c]/30 dark:border-[#dc143c]/40 rounded-2xl p-8 md:p-12 lg:p-16 text-center">
